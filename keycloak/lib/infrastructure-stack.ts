...
export class InfrastructureStack extends Stack {
    ...
    constructor(scope: Construct, id: string, props?: StackProps) {
        ...
        const keycloakUtilsStack = new KeycloakUtils(app, 'KeyCloakUtils', {
            hostedZone: InfrastructureStack.HOSTED_ZONE
        })
        ...
        const keycloak = new KeycloakStack(app, 'Keycloak', {
            ...
            keycloakDBpasswordSecretArn : keycloakUtilsStack.keycloakDBpasswordSecretArn,
            keycloakAdminUserSecretArn : keycloakUtilsStack.keycloakAdminUserSecretArn,
            keycloakAdminPasswordSecretArn : keycloakUtilsStack.keycloakAdminPasswordSecretArn,
            keycloakCertPemSecretArn : keycloakUtilsStack.keycloakCertPemSecretArn,
            keycloakCertKeySecretArn : keycloakUtilsStack.keycloakCertKeySecretArn,
            albProps: {
                certificateArn : keycloakUtilsStack.certificateArn,
